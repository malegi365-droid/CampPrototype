...
public class ToxicologistProjectileFireController : MonoBehaviour
{
    ...
    private void FireProjectile(Vector2 mouseScreenPosition)
    {
        if (projectilePrefab == null)
        {
            Debug.LogWarning("[ToxicologistProjectileFireController] Missing projectile prefab.");
            return;
        }

        if (projectileSpawnPoint == null)
        {
            Debug.LogWarning("[ToxicologistProjectileFireController] Missing projectile spawn point.");
            return;
        }
